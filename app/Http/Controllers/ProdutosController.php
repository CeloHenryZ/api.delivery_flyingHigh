...
class ProdutosController extends Controller
{
    ...
    public function byLike(Request $req)
    {
        ...
        $produtos = Produtos::with('imagens')->with('quantidades')
            ->with('categoria')
    ...
    public function ByCategory(Request $req)
    {
        ...
        $data = Produtos::with('imagens')->with('quantidades')
    ...
    public function allAbout($id)
    {
        ...
        if($data){
            ...
            return response()->json('id nao encontrado', 409);
        }
    }
    ...
    public function store(Request $req)
    {
        ...
        $valorPedido = (float)$req->valor;

        if($categoria->id_categoria == null){
            return response('id_categoria nao informado', 422);
        }
    ...
    public function inativa(Request $req)
    {
        ...
        if($produto->isActive === 0){
            ...
            return response()->json(["n達o foi poss鱈vel desativar o produto"], Response::HTTP_BAD_REQUEST);
        }
    }
